...
def get_pronunciation_assessment(wav_data: bytes, reference_text: str) -> dict:
    ...
    headers = {'Content-Type': 'audio/wav; codecs=audio/pcm; samplerate=16000', 'Ocp-Apim-Subscription-Key': AZURE_SPEECH_KEY, 'Pronunciation-Assessment': json.dumps(params), 'Accept': 'application/json;text/xml'}
    try:
